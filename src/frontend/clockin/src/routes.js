    ...
    <BrowserRouter>
      <UserProvider>
        ...
        <Routes>
          ...
          <Route path="/rh/:userId/colaboradores/:employeeId" element={<Employee/>}/>
          <Route path="/rh/:userId/colaboradores/:employeeId/registros" element={<TimeLogs/>}/>
          <Route path="/rh/:userId/colaboradores/:employeeId/contracheques" element={<Paychecks/>}/>
          <Route path="/rh/:userId/colaboradores/:employeeId/contracheques/:paycheckId" element={<Paycheck/>}/>
